<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
  ...
  >
    ...
    <div class="flex flex-col gap-4">
      <p class="font-bold ibmpm text-base sm:text-lg">Support</p>
      <a
        href=""
        target="_blank"
    ...
    <div class="flex flex-col gap-4">
      <p class="font-bold ibmpm text-base sm:text-lg">Research</p>
      <a
        href=""
        target="_blank"
        class="cursor-pointer hover:text-indigo-400 duration-200"
    ...
    <div class="flex flex-col gap-4">
      <p class="font-bold ibmpm text-base sm:text-lg">Follow Us</p>
      <a
        href=""
        target="_blank"
        class="cursor-pointer hover:text-indigo-400 duration-200"
